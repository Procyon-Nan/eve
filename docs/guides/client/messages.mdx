...
attachments](../../sandbox#inbound-attachments) for how eve either stages byte-backed files in the
session sandbox or passes them directly to the model when the agent disables its sandbox.
